...
_lr_productions = [
  ...
  ('program -> INIT commands END','program',3,'p_program','myparser.py',59),
  ('commands -> command','commands',1,'p_commands','myparser.py',66),
  ('commands -> command commands','commands',2,'p_commands','myparser.py',67),
  ('command -> assignment','command',1,'p_command','myparser.py',74),
  ('command -> conditional','command',1,'p_command','myparser.py',75),
  ('command -> loop','command',1,'p_command','myparser.py',76),
  ('command -> input','command',1,'p_command','myparser.py',77),
  ('command -> output','command',1,'p_command','myparser.py',78),
  ('command -> block','command',1,'p_command','myparser.py',79),
  ('assignment -> ID ASSIGN expression','assignment',3,'p_assignment','myparser.py',83),
  ('assignment -> ID ASSIGN STRING','assignment',3,'p_assignment','myparser.py',84),
  ('expression -> term','expression',1,'p_expression','myparser.py',88),
  ('expression -> term PLUS expression','expression',3,'p_expression','myparser.py',89),
  ('expression -> term MINUS expression','expression',3,'p_expression','myparser.py',90),
  ('expression -> LT ID GT','expression',3,'p_expression','myparser.py',91),
  ('term -> factor','term',1,'p_term','myparser.py',100),
  ('term -> factor TIMES term','term',3,'p_term','myparser.py',101),
  ('term -> factor DIVIDE term','term',3,'p_term','myparser.py',102),
  ('factor -> NUMBER','factor',1,'p_factor','myparser.py',109),
  ('factor -> REAL','factor',1,'p_factor','myparser.py',110),
  ('factor -> ID','factor',1,'p_factor','myparser.py',111),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','myparser.py',112),
  ('conditional -> PIF LPAREN condition RPAREN block optional_else','conditional',6,'p_conditional','myparser.py',119),
  ('conditional -> PIF LPAREN condition RPAREN block','conditional',5,'p_conditional','myparser.py',120),
  ('optional_else -> PAF block','optional_else',2,'p_optional_else','myparser.py',126),
  ('optional_else -> empty','optional_else',1,'p_optional_else','myparser.py',127),
  ('condition -> expression relational_op expression','condition',3,'p_condition','myparser.py',134),
  ('relational_op -> EQUAL','relational_op',1,'p_relational_op','myparser.py',138),
  ('relational_op -> GE','relational_op',1,'p_relational_op','myparser.py',139),
  ('relational_op -> LE','relational_op',1,'p_relational_op','myparser.py',140),
  ('relational_op -> GT','relational_op',1,'p_relational_op','myparser.py',141),
  ('relational_op -> LT','relational_op',1,'p_relational_op','myparser.py',142),
  ('relational_op -> NE','relational_op',1,'p_relational_op','myparser.py',143),
  ('loop -> PHILE LPAREN condition RPAREN block','loop',5,'p_loop','myparser.py',147),
  ('increment -> ID PLUSPLUS','increment',2,'p_increment','myparser.py',151),
  ('increment -> ID MINUSMINUS','increment',2,'p_increment','myparser.py',152),
  ('block -> LBRACE commands RBRACE','block',3,'p_block','myparser.py',156),
  ('block -> LBRACE commands PEND','block',3,'p_block','myparser.py',157),
  ('block -> PEGIN commands RBRACE','block',3,'p_block','myparser.py',158),
  ('block -> PEGIN commands PEND','block',3,'p_block','myparser.py',159),
  ('input -> PIN ID','input',2,'p_input','myparser.py',163),
  ('output -> POUT expression','output',2,'p_output','myparser.py',167),
  ('output -> POUT STRING','output',2,'p_output','myparser.py',168),
  ('empty -> <empty>','empty',0,'p_empty','myparser.py',172),
]
