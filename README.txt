...
Compilação e Execução:
    ...
    Tokenização:
        ...
        Para tokenizar um arquivo de código fonte, utilize a função tokenize_file em lexer.py. 
        Por exemplo:

            from lexer import tokenize_file
            tokenize_file("codigos_fonte/codigo_fonte.txt")

    Análise Sintática:

        Para analisar a estrutura do código fonte tokenizado e gerar descrições dos comandos 
        presentes, utilize a função parse_file em myparser.py. Por exemplo:

            from myparser import parse_file
            parse_file("codigos_fonte/codigo_fonte.txt")

    Tradução para Python:

        Para traduzir as descrições dos comandos da linguagem Pinguim para Python, utilize a 
        função translate_to_python em translator.py. Por exemplo:

            from translator import translate_to_python
            translate_to_python("codigos_fonte/codigo_fonte.txt")
